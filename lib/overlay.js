...
const { overlayOptions } = require('../constants/defaults/overlayDefaults')
const { asyncForEach } = require('./index')

const VID_WIDTH = overlayOptions.VID_WIDTH;
const VID_HEIGHT = overlayOptions.VID_HEIGHT;
const ROUNDED_TEXTBOX = overlayOptions.ROUNDED_TEXTBOX;
const ARC_RADIUS = overlayOptions.ARC_RADIUS;
...
testOverlay("./test_files/testOverlay.json", "./test_files/testOverlay.png");