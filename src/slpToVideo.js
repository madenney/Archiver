...
const configureDolphin = async (config) => {
  ...
  if (true) newSettings.push("$Optional: Prevent Character Crowd Chants")
  if (true) newSettings.push("$Optional: Disable Magnifying-glass HUD [NeilHarbin0]")
  if (true) newSettings.push("$Optional: Force 2P Center HUD [UnclePunch]")
